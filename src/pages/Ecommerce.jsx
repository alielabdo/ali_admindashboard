      ...
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl text-black'>$57,835.73</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button
        ...
        <div className='flex m-3 flex-wrap justify-center gap-1 items-center'>
          {earningData.map((item) => (
            <div
              key={item.title}
              className='bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-[13rem] p-4 pt-9 rounded-2xl'
            >
              <button
                type='button'
                style={{
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  <span className='text-3xl font-semibold'>$78,376</span>
              ...
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>$37,257</span>
                </p>
                <p className='text-gray-500 mt-1'>
                  Expense
                </p>
